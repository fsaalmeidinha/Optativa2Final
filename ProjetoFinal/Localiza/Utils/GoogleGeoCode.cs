    ...
    public class GoogleGeoCode
    {
        ...
        public static Coordenadas GetCoordenadas(string endereco)
        {
            ...
            */
            ...
            return new Coordenadas(Convert.ToDecimal(geocodeInfo[2], new System.Globalization.CultureInfo("en-US")), Convert.ToDecimal(geocodeInfo[3], new System.Globalization.CultureInfo("en-US")));
        }
